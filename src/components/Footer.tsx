      ...
      <div className="">
        <div className=" rounded-xl px-10 w-full h-auto py-8 flex items-center justify-center gap-2 flex-wrap">
          <div
            className=""
            onClick={() => {
              window.location.href = "https://www.instagram.com/expead_drives";
            }}
          >
            <a
              href="javascript:;"
        ...
        <div className="text-black">
          Copywrite &copy; 2025 ExpeAdDrives &reg;
        </div>
      </div>
      <div className="text-black">
        <div className="flex justify-around">
          ...
          <div className="">expeaddrives@gmail.com</div>
        </div>
        <div className="flex ">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="">+91 8180861415</div>
        </div>
      </div>
    </div>
  );
