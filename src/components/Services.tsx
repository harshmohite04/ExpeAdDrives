...
function Services() {
  ...
  return (
    ...
    >
      ...
      <div className="h-screen py-10 bg-black flex flex-col pt-20 items-center">
      ...
      <div className="h-screen bg-zinc-900 flex flex-col justify-around items-center"></div>
